...
ru_strs = {
    ...
    'admin_enter_username': '<b>Введите имя базы данных</b>',
    'admin_enter_password': '<b>Введите пароль базы данных</b>',
    'admin_url': '<i>Ссылка на админ-панель: </i>',
    'admin_wrong': '<b>Неверное имя базы данных или неверный пароль!</b>',
    'use_menu_keyboard': 'Воспользуйтесь кнопками меню!',
